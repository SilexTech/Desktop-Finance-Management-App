...
public class ViewCashDisbursements extends View {
    ...
    public ViewCashDisbursements(Group group) {
        super(group);
    }
    ...
    public void load() {
        ...
        incomeFilter.bind(Bindings.createObjectBinding(() ->
                transaction -> transaction.getType() == ModelTransaction.Type.CASH_DISBURSEMENT));
        ...
        supplierFilter.bind(Bindings.createObjectBinding(() ->
                person -> person.getType() == ModelPerson.Type.NATURAL_SUPPLIER));
