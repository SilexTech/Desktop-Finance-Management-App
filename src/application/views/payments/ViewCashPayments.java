...
public class ViewCashPayments extends View {
    ...
    public ViewCashPayments(Group group) {
        super(group);
    }
    ...
    public void load() {
        ...
        incomeFilter.bind(Bindings.createObjectBinding(() ->
                transaction -> transaction.getType() == ModelTransaction.Type.CASH_PAYMENT));
        ...
        clientFilter.bind(Bindings.createObjectBinding(() ->
                person -> person.getType() == ModelPerson.Type.NATURAL_CLIENT));
